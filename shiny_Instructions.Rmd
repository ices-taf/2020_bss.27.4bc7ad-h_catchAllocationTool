...
The assumptions used in the tool are closely linked to the assessment of this stock (ICES,2020a) and any attempt to use it for other stocks will not produce sensible results.

<br>

The sea bass catch allocation tool was developed with the intent to aid managers and stakeholders to test multiple catch allocation schemes by gear and different regulations for recreational catches, using the ICES catch advice (ICES, 2020c) as a maximum.
...
ICES.2020c. Sea  bass(Dicentrarchus  labrax)  in  divisions 4.b–c,7.a,  and 7.d–h (central  and southern  North  Sea,  Irish  Sea,  English  Channel,  Bristol  Channel,  and  Celtic  Sea. In Report  of  the  ICES  Advisory Committee, 2020. ICES Advice 2020, bss.27.4bc7ad-h. https://doi.org/10.17895/ices.advice.5916
