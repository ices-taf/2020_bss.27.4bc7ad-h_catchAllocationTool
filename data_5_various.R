...
other_data$Fbar_rec_2019 <- 0.018829873
...
other_data$discard_prop <- read.csv("bootstrap/data/other/discard_proportions.csv")

other_data$noVessels <- read.taf("bootstrap/data/other/Number_Vessels.csv")

## Recreational fisheries
# F multipliers for bag limits and closed seasons
other_data$RecFs <- read.csv("bootstrap/data/BagLimitFs.csv")

other_data$AdviceScenarios <- read.csv("bootstrap/data/other/bss.27.4bc7ad-h 2019 Advice scenarios.csv")
